...
// Measure DAB intensity in !BACKGROUND
...
def threshold = "Otsu" // "Default", "Huang", "Intermodes", "IsoData", "IJ_IsoData", "Li", "MaxEntropy", "Mean", "MinError", "Minimum", "Moments", "Otsu", "Percentile", "RenyiEntropy", "Shanbhag", "Triangle", "Yen"
...
String classAbove = "AT8" // null or "Class Name"; use this for positive deconvoluted or fluorescence channels
...
if (annoList) {
    ...
    annoList.forEach{ anno ->
        ...
        def areaAT8MeasurementName = "Fixed threshold: ${classAbove} area µm^2"
        ...
        def fixedThresholdBgCorrectedAT8Area = anno.measurements.get(areaAT8MeasurementName.toString())
        anno.measurements.put("BG corrected Fixed threshold: ${classAbove} area µm^2", fixedThresholdBgCorrectedAT8Area)
        ...
        def autoThresholdBgCorrectedAT8Area = anno.measurements.get(areaAT8MeasurementName.toString())
        anno.measurements.put("BG corrected ${threshold} threshold: ${classAbove} area µm^2", autoThresholdBgCorrectedAT8Area)
